...
public class Bookmark {
	 ...
	 * 用户名
	 */
	@NotNull(message="用户名不能为空",groups={UpdateBookmark.class,DelBookmark.class,Default.class})
	@Size(min=5,max=20,message="用户名称长度应为5~20",groups={UpdateBookmark.class,DelBookmark.class,Default.class})
